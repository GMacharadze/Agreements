...
/**
 * Класс, определяющий структуру блока changes
 ...
 */
public class Changes extends AbstractBlock {

    public Changes(JSONObject object, String id_info) {
        super(5, "changes");
        this.fieldName = new String[]{
                "id_info", "num", "text", "docdate", "date"
        };
        data = new HashMap<>();
